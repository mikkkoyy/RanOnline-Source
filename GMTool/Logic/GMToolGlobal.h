...
enum CHARPAGE_SEARCH_TYPE
{
	...
	CHARPAGE_SEARCH_TYPE_ALL		= 4,
	CHARPAGE_SEARCH_TYPE_SIZE		= 5,
};
...
/* GM TOOL ITEM SHOP EDIT ITEM ITEMSEC - ADDED BY ARWEKAJ09 09.08.2024*/
enum EMSHOPITEM_ITEMSEC
{
	EMSHOPITEM_ITEMSEC_ALL						= 0,
	EMSHOPITEM_ITEMSEC_FASHION_HEADER			= 1,
	EMSHOPITEM_ITEMSEC_FASHION_OUTFITS			= 2,
	EMSHOPITEM_ITEMSEC_FASHION_WEAPONS			= 3,
	EMSHOPITEM_ITEMSEC_WINGS					= 4,
	EMSHOPITEM_ITEMSEC_PETS						= 5,
	EMSHOPITEM_ITEMSEC_VEHICLES					= 6,
	EMSHOPITEM_ITEMSEC_CARDS					= 7,
	EMSHOPITEM_ITEMSEC_GIFT_BOX					= 8,
	EMSHOPITEM_ITEMSEC_EXP_ITEMS				= 9,
	EMSHOPITEM_ITEMSEC_GEN_ITEMS				= 10,
	EMSHOPITEM_ITEMSEC_PROMO_ITEMS				= 11,
	EMSHOPITEM_ITEMSEC_SIZE						= 12
};

/* GM TOOL ITEM SHOP EDIT ITEM ITEMCATEGORY - ADDED BY ARWEKAJ09 09.08.2024*/
enum EMSHOPITEM_ITEMCATEGORY
{
	EMSHOPITEM_ITEMCATEGORY_EPOINT			= 0,
	EMSHOPITEM_ITEMCATEGORY_GPOINT			= 1,
	EMSHOPITEM_ITEMCATEGORY_SIZE			= 2
};
...
namespace GMTOOL_GLOBAL
{
	...
	extern std::string strAccountLevelIndex[EM_TYPE_SIZE];
	extern std::string strItemSec[EMSHOPITEM_ITEMSEC_SIZE];
	extern std::string strItemCategory[EMSHOPITEM_ITEMCATEGORY_SIZE];
};
