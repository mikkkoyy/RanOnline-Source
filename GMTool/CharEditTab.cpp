...
CCharEditTab::CCharEditTab( SCHARDATA2* pData, CRect& rect, LOGFONT logfont, CWnd* pParentWnd /*= NULL*/ )
	...
	m_PageCodex ( logfont, pData ),/*Codex System, Jhoniex 2/14/2024 */
	...
	m_pData( NULL )
{
	...
	m_PageCodex.SetSheetTab ( this ); /*Codex System, Jhoniex 2/14/2024 */
	...
	AddPage ( &m_PageCodex );/*Codex System, Jhoniex 2/14/2024 */
