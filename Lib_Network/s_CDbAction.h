...
public:
	...
	/*dmk14 ingame web*/
	void Init ( DWORD dwClientID, DWORD dwUserID, DWORD dwUserLvl, __time64_t tPREMIUM, __time64_t tCHATBLOCK, 
				DWORD dwServerID, DWORD dwCharID, DWORD dwPremiumPoints, DWORD dwCombatPoints, EMACCTYPE emUserType );
	virtual int Execute ( CServer* pServer );
