...
//	NET_MSG_PING_ANSWER		    = 151, //< 서버에서 ping 을 응답한다.	
	...
	NET_MSG_LOBBY_CHAR_CODEX_PROG	= (NET_MSG_LOBBY + 458),
	NET_MSG_LOBBY_CHAR_CODEX_DONE	= (NET_MSG_LOBBY + 459),

	/*dmk14 ingame web*/
	NET_MSG_FORGOTPASS					= (NET_MSG_LOBBY + 442),
	NET_MSG_FORGOTPASS_FB				= (NET_MSG_LOBBY + 443),
	NET_MSG_CHANGEPASS					= (NET_MSG_LOBBY + 444),
	NET_MSG_CHANGEPASS_FB				= (NET_MSG_LOBBY + 445),
	NET_MSG_SELCHAR_CHANGEPASS			= (NET_MSG_LOBBY + 446),
	NET_MSG_SELCHAR_CHANGEPASS_FB		= (NET_MSG_LOBBY + 447),
	NET_MSG_SELCHAR_CHANGEPIN			= (NET_MSG_LOBBY + 448),
	NET_MSG_SELCHAR_CHANGEPIN_FB		= (NET_MSG_LOBBY + 449),
	NET_MSG_REQ_GAMETIME_CONVERT		= (NET_MSG_LOBBY + 450),
	NET_MSG_REQ_GAMETIME_CONVERT_FB		= (NET_MSG_LOBBY + 451),
	NET_MSG_SELCHAR_RESETPIN			= (NET_MSG_LOBBY + 452),
	NET_MSG_SELCHAR_RESETPIN_FB			= (NET_MSG_LOBBY + 453),
	NET_MSG_SELCHAR_CHANGEMAIL			= (NET_MSG_LOBBY + 454),
	NET_MSG_SELCHAR_CHANGEMAIL_FB		= (NET_MSG_LOBBY + 455),
	NET_MSG_SELCHAR_TOPUP				= (NET_MSG_LOBBY + 456),
	NET_MSG_SELCHAR_TOPUP_FB			= (NET_MSG_LOBBY + 457),
...
//	NET_MSG_APEX_RSAKEY				= (NET_MSG_GCTRL +	32), //< Apex RSA Key 메세지
	...
	NET_MSG_GCTRL_REQ_STATSUPCMD	= (NET_MSG_GCTRL + 387),	//<	STATS UP CMD 응답.
	NET_MSG_GCTRL_REQ_STATSUPCMD_FB	= (NET_MSG_GCTRL + 388),	//<	STATS UP CMD 응답.
	...
	NET_MSG_GM_CAMERA_ONOFF				= (NET_MSG_GCTRL + 719),	//<	개인 상점 오픈.
...
//-----------------------------------------------------------------------------------------------------------
	...
	/*dmk14 reform*/
	NET_MSG_REBUILD_MOVE_ITEMSEALED		= (NET_MSG_GCTRL + 1029),
...
//-----------------------------------------------------------------------------------------------------------
	...
	NET_MSG_GCTRL_REMOVE_SKILL_EFFECT_REQ		= (NET_MSG_GCTRL + 1531),	//<	퀘스트 맵이동 제한.
	NET_MSG_GCTRL_REMOVE_SKILL_EFFECT_BRD		= (NET_MSG_GCTRL + 1532),	//<	퀘스트 맵이동 제한.
	...
	NET_MSG_GCTRL_GET_PARTYLIST						= (NET_MSG_GCTRL + 1892),
	NET_MSG_GCTRL_GET_PARTYLIST_FB					= (NET_MSG_GCTRL + 1893),
	NET_MSG_GCTRL_PARTY_SEARCH_LURE					= (NET_MSG_GCTRL + 1894),	//<	파티 가입 요청.			클라이언트 -> 서버.
	NET_MSG_GCTRL_PARTY_SEARCH_LURE_FB				= (NET_MSG_GCTRL + 1895),	//<	파티 가입 요청의 결과.	클라이언트 -> 서버.
	NET_MSG_GCTRL_PARTY_SEARCH_LURE_REQUESTOR_FB	= (NET_MSG_GCTRL + 1896),
	NET_MSG_GCTRL_PARTY_SEARCH_LURE_TAR_ANS			= (NET_MSG_GCTRL + 1897),	//<	파티 가입 요청 응답.	클라이언트 -> 서버.
	/*PartySearch - Added By Bubu*/
	NET_MSG_GCTRL_REQ_PARTY_SEARCH_UPDATE			= (NET_MSG_GCTRL + 1898),	//<	클럽데스매치 상황 요청

	//
	NET_MSG_GCTRL_ITEM_COMPOUND_CANCEL				= (NET_MSG_GCTRL + 1901),

	/////////////////////////////////////////////////////////////////////////////

	NET_MSG_RESET_STATS_REQ							= (NET_MSG_GCTRL + 1905),  //! 조합으로 숙련도를 습득한 목록 응답
	NET_MSG_RESET_STATS_FB							= (NET_MSG_GCTRL + 1906),  //! 조합으로 숙련도를 습득한 목록 응답
	// LG-7 CWRanking
	NET_MSG_GCTRL_REQ_CW_RANKING					= (NET_MSG_GCTRL + 1907),
	NET_MSG_GCTRL_REQ_CW_RANKING_FB					= (NET_MSG_GCTRL + 1908),
	NET_MSG_GCTRL_REQ_MY_CW_RANKING					= (NET_MSG_GCTRL + 1909),
	NET_MSG_GCTRL_REQ_MY_CW_RANKING_FB				= (NET_MSG_GCTRL + 1910),
	/////////////////////////////////////////////////////////////////////////////

	//Mystery Key & Box
	NET_MSG_GCTRL_MYSTERY_BOX						= (NET_MSG_GCTRL + 1911), //Mystery Box
	NET_MSG_GCTRL_MYSTERY_BOX_FB 					= (NET_MSG_GCTRL + 1912), //Mystery Box
	
	NET_MSG_GCTRL_CARD_BRIGHT							= (NET_MSG_GCTRL + 1913),
	NET_MSG_GCTRL_CARD_BRIGHT_FB						= (NET_MSG_GCTRL + 1914),

	NET_MSG_GCTRL_CARD_EPOINT							= (NET_MSG_GCTRL + 1915),
	NET_MSG_GCTRL_CARD_EPOINT_FB						= (NET_MSG_GCTRL + 1916),
	NET_MSG_GCTRL_RECEIVE_EPOINT						= (NET_MSG_GCTRL + 1917),
	
	NET_MSG_GCTRL_SLOT_EVENT_GEN_FLD				= (NET_MSG_GCTRL + 1918),
	NET_MSG_GCTRL_SLOT_EVENT_GEN_BRD				= (NET_MSG_GCTRL + 1919),
	
	NET_MSG_GCTRL_CARD_CONTRIBUTION					= (NET_MSG_GCTRL + 1922),
	NET_MSG_GCTRL_CARD_CONTRIBUTION_FB				= (NET_MSG_GCTRL + 1923),

	//Teleport Skill Effect
	NET_MSG_GCTRL_TELEPORT_BRD 						= (NET_MSG_GCTRL + 1924),

	NET_MSG_GCTRL_INVEN_REFORM_WEAPON				= (NET_MSG_GCTRL + 1925), //Weapon Skill Reform Card - SqueeeAK
	NET_MSG_GCTRL_INVEN_REFORM_WEAPON_FB			= (NET_MSG_GCTRL + 1926), //Weapon Skill Reform Card - SqueeeAK

	/*storage lock, Juver, 2018/01/13 */
	NET_MSG_GCTRL_STORAGE_LOCK_ENABLE					= (NET_MSG_GCTRL + 2001),
	NET_MSG_GCTRL_STORAGE_LOCK_ENABLE_FB				= (NET_MSG_GCTRL + 2002),
	NET_MSG_GCTRL_STORAGE_LOCK_ENABLE_FROM_DB			= (NET_MSG_GCTRL + 2003),
	NET_MSG_GCTRL_STORAGE_LOCK_INPUT					= (NET_MSG_GCTRL + 2004),
	NET_MSG_GCTRL_STORAGE_LOCK_INPUT_FB					= (NET_MSG_GCTRL + 2005),
	NET_MSG_GCTRL_STORAGE_LOCK_INPUT_FROM_DB			= (NET_MSG_GCTRL + 2006),
	NET_MSG_GCTRL_STORAGE_LOCK_RECOVER					= (NET_MSG_GCTRL + 2007),
	NET_MSG_GCTRL_STORAGE_LOCK_RECOVER_FB				= (NET_MSG_GCTRL + 2008),
	NET_MSG_GCTRL_STORAGE_LOCK_RECOVER_FROM_DB			= (NET_MSG_GCTRL + 2009),
	NET_MSG_GCTRL_STORAGE_LOCK_RECOVER_CHANGE			= (NET_MSG_GCTRL + 2010),
	NET_MSG_GCTRL_STORAGE_LOCK_RECOVER_CHANGE_FB		= (NET_MSG_GCTRL + 2011),
	NET_MSG_GCTRL_STORAGE_LOCK_RECOVER_CHANGE_FROM_DB	= (NET_MSG_GCTRL + 2012),
	NET_MSG_GCTRL_STORAGE_LOCK_RECOVER_DELETE			= (NET_MSG_GCTRL + 2013),
	NET_MSG_GCTRL_STORAGE_LOCK_RECOVER_DELETE_FB		= (NET_MSG_GCTRL + 2014),
	NET_MSG_GCTRL_STORAGE_LOCK_RECOVER_DELETE_FROM_DB	= (NET_MSG_GCTRL + 2015),

	/*inventory lock, Juver, 2018/01/13 */
	NET_MSG_GCTRL_INVENTORY_LOCK_ENABLE					= (NET_MSG_GCTRL + 2020),
	NET_MSG_GCTRL_INVENTORY_LOCK_ENABLE_FB				= (NET_MSG_GCTRL + 2021),
	NET_MSG_GCTRL_INVENTORY_LOCK_ENABLE_FROM_DB			= (NET_MSG_GCTRL + 2022),
	NET_MSG_GCTRL_INVENTORY_LOCK_INPUT					= (NET_MSG_GCTRL + 2023),
	NET_MSG_GCTRL_INVENTORY_LOCK_INPUT_FB				= (NET_MSG_GCTRL + 2024),
	NET_MSG_GCTRL_INVENTORY_LOCK_INPUT_FROM_DB			= (NET_MSG_GCTRL + 2025),
	NET_MSG_GCTRL_INVENTORY_LOCK_RECOVER				= (NET_MSG_GCTRL + 2026),
	NET_MSG_GCTRL_INVENTORY_LOCK_RECOVER_FB				= (NET_MSG_GCTRL + 2027),
	NET_MSG_GCTRL_INVENTORY_LOCK_RECOVER_FROM_DB		= (NET_MSG_GCTRL + 2028),
	NET_MSG_GCTRL_INVENTORY_LOCK_RECOVER_CHANGE			= (NET_MSG_GCTRL + 2029),
	NET_MSG_GCTRL_INVENTORY_LOCK_RECOVER_CHANGE_FB		= (NET_MSG_GCTRL + 2030),
	NET_MSG_GCTRL_INVENTORY_LOCK_RECOVER_CHANGE_FROM_DB	= (NET_MSG_GCTRL + 2031),
	NET_MSG_GCTRL_INVENTORY_LOCK_RECOVER_DELETE			= (NET_MSG_GCTRL + 2032),
	NET_MSG_GCTRL_INVENTORY_LOCK_RECOVER_DELETE_FB		= (NET_MSG_GCTRL + 2033),
	NET_MSG_GCTRL_INVENTORY_LOCK_RECOVER_DELETE_FROM_DB	= (NET_MSG_GCTRL + 2034),
   ...
   /*get process command, Juver, 2017/06/08 */
	...
	/*dmk14 ingame web*/
	NET_MSG_GCTRL_GET_ITEMMALL_FROMDB				= (NET_MSG_GCTRL + 3040),
	NET_MSG_GCTRL_GET_ITEMMALL_FROMDB_FB			= (NET_MSG_GCTRL + 3041),	

	NET_MSG_GCTRL_REQ_BUY_FROM_ITEMMALL				= (NET_MSG_GCTRL + 3042),

	/*dmk14 topup generator*/
	NET_MSG_GCTRL_GEN_TOPUP_PIN						= (NET_MSG_GCTRL + 3043),
	NET_MSG_GCTRL_GEN_TOPUP_PIN_FB					= (NET_MSG_GCTRL + 3044),
	NET_MSG_GCTRL_VIEW_TOPUP						= (NET_MSG_GCTRL + 3045),
	NET_MSG_GCTRL_VIEW_TOPUP_FB						= (NET_MSG_GCTRL + 3046),

	/*dmk14 remove active buff selection*/
	NET_MSG_GCTRL_REQ_DISABLESKILLEFF				= (NET_MSG_GCTRL + 3050),
	NET_MSG_GCTRL_REQ_DISABLESKILLEFF_BRD			= (NET_MSG_GCTRL + 3051),
	NET_MSG_GCTRL_REQ_DISABLESKILLEFF_FB			= (NET_MSG_GCTRL + 3052),

	NET_MSG_GCTRL_REQ_DISABLEITEMFACT				= (NET_MSG_GCTRL + 3053),
	NET_MSG_GCTRL_REQ_DISABLEITEMFACT_BRD			= (NET_MSG_GCTRL + 3054),
	NET_MSG_GCTRL_REQ_DISABLEITEMFACT_FB			= (NET_MSG_GCTRL + 3055),

	/////////////////////////////////////////////////////////////////////////////
	// LG-7 GlobalRanking
	NET_MSG_GCTRL_REQ_GLOBAL_RANKING				= (NET_MSG_GCTRL + 3065),
	NET_MSG_GCTRL_REQ_GLOBAL_RANKING_FB				= (NET_MSG_GCTRL + 3066),
	NET_MSG_GCTRL_REQ_GLOBAL_RANKING_KILL_UPDATE	= (NET_MSG_GCTRL + 3067),
	NET_MSG_GCTRL_REQ_GLOBAL_RANKING_KILL_AGT		= (NET_MSG_GCTRL + 3068),
	NET_MSG_GCTRL_REQ_GLOBAL_RANKING_RICH_UPDATE	= (NET_MSG_GCTRL + 3069),
	NET_MSG_GCTRL_REQ_GLOBAL_RANKING_RICH_AGT		= (NET_MSG_GCTRL + 3070),
	NET_MSG_GCTRL_REQ_GLOBAL_RANKING_GUILD_AGT		= (NET_MSG_GCTRL + 3071),
	/////////////////////////////////////////////////////////////////////////////

	/*Codex System, Jhoniex 2/14/2024 */
	NET_MSG_GCTRL_CODEX_COMPLETE_BRD				= (NET_MSG_GCTRL + 3072 ),
	NET_MSG_GCTRL_CODEX_UPDATE						= (NET_MSG_GCTRL + 3073 ),
	NET_MSG_GCTRL_CODEX_COMPLETE					= (NET_MSG_GCTRL + 3074 ),

	NET_MSG_GCTRL_CODEX_NOTIFY_AGENT				= (NET_MSG_GCTRL + 3075 ),
	NET_MSG_GCTRL_CODEX_NOTIFY_CLIENT				= (NET_MSG_GCTRL + 3076 ),
	NET_MSG_GCTRL_REGISTER_CODEX					= (NET_MSG_GCTRL + 3076),//codex jhnoiex 2/5/2024
	NET_MSG_GCTRL_REGISTER_CODEX_FB					= (NET_MSG_GCTRL + 3077),//codex jhnoiex 2/5/2024

	//PANDORA
    NET_MSG_PANDORA_BOX_SETTING_INFO = (NET_MSG_GCTRL + 3078 ),
    NET_MSG_PANDORA_BOX_OPEN_REQ = (NET_MSG_GCTRL + 3079),
    NET_MSG_PANDORA_BOX_OPEN_FB = (NET_MSG_GCTRL + 3080),
    NET_MSG_PANDORA_BOX_RESULT = (NET_MSG_GCTRL + 3081 ),
    NET_MSG_PANDORA_BOX_BUY_ITEM = (NET_MSG_GCTRL + 3082 ),
    NET_MSG_PANDORA_BOX_BUY_ITEM_FB = (NET_MSG_GCTRL + 3083 ),
    NET_MSG_PANDORA_BOX_REWARD_RARE_BRD = (NET_MSG_GCTRL + 3084 ),
    NET_MSG_PANDORA_BOX_CLEAR_RESULTS_REQ = (NET_MSG_GCTRL + 3085 ),
    NET_MSG_PANDORA_BOX_CLEAR_RESULTS_FB = (NET_MSG_GCTRL + 3086 ),
	NET_MSG_PANDORA_BOX_REFRESH_RESULT = (NET_MSG_GCTRL + 3087),
	
	NET_MSG_GCTRL_MAX											= (NET_MSG_GCTRL + 3900) // 게임서버 게임플레이 최대값
};
...
struct NET_LOGIN_FEEDBACK_DATA2
{
	...
	/*dmk14 ingame web*/
	DWORD			dwPremiumPoints;
	DWORD			dwCombatPoints;
	DWORD			dwGameTime;
	...
	NET_LOGIN_FEEDBACK_DATA2()
	{
		...
		bGameTime = false;	/*dmk14 level required gametime*/
...
struct ITEMSHOP
{
   // CString strPurKey;
	...
	ITEMSHOP( const ITEMSHOP &value ) 
		...
		, wItemVIPRank(value.wItemVIPRank)
		, wItemVIPType(value.wItemVIPType)
    {
	}
