...
{
	m_dwPremiumPoints = dwPoints;
}

DWORD CNetUser::GetPremiumPoints()
{
	return m_dwPremiumPoints;
}

void CNetUser::SetCombatPoints( DWORD dwPoints )
{
	m_dwCombatPoints = dwPoints;
}

DWORD CNetUser::GetCombatPoints()
{
	return m_dwCombatPoints;
}

void CNetUser::SetAccType( EMACCTYPE emAccType )
{
	m_emUserType = emAccType;
}

EMACCTYPE CNetUser::GetAccType()
{
	return m_emUserType;
}
...
/*dmk14 level required gametime*/
void CNetUser::SetGainGameTime( bool bGain )
{
	m_bGameTimeGain = bGain;
}

bool CNetUser::GetGainGameTime()
{
	return m_bGameTimeGain;
}