...
public:
	...
	/*dmk14 blocker*/
	bool			bBlockCMD;
	MAP_CLIENTIP	m_mapClientIP_BLOCK;
...
public:
	...
	void	SetGainGameTime		( DWORD dwClient, bool bGain );
	bool	GetGainGameTime		( DWORD dwClient );	
	...
	void	SetAccType			(DWORD dwClient, EMACCTYPE emAccType );
	EMACCTYPE GetAccType		(DWORD dwClient);
	...
	//iplimit
public:
	void	IPSetClientMax( WORD _wMAX, bool bBlockCMD = false );	/*dmk14 blocker*/
