...
public:
	...
	*/
	...
	int UpdateMoneyPoint( DWORD dwPremium, CString strUserID );

	//PANDORA - Added by Arwekaj09 to Deduct UserPoint or E-Points
	int DeductMoneyPoint( DWORD dwPremium, CString strUserID );
    ...
    **************************************************************************/
	...
	int StorageLockEnable (DWORD dwChaNum, char* szChaName, char* szSPin );
	int StorageLockInput (DWORD dwChaNum, char* szChaName, char* szSPin );
	int StorageLockRecover (DWORD dwChaNum, char* szChaName, std::string& strSPin );
	int StorageLockRecoverChange (DWORD dwChaNum, char* szChaName, char* szSPin );
	int StorageLockRecoverDelete (DWORD dwChaNum, char* szChaName );

	/*inventory lock, Juver, 2018/01/14 */
	int InventoryLockEnable (DWORD dwChaNum, char* szChaName, char* szIPin );
	int InventoryLockInput (DWORD dwChaNum, char* szChaName, char* szIPin );
	int InventoryLockRecover (DWORD dwChaNum, char* szChaName, std::string& strIPin );
	int InventoryLockRecoverChange (DWORD dwChaNum, char* szChaName, char* szIPin );
	int InventoryLockRecoverDelete (DWORD dwChaNum, char* szChaName );
	/*dmk14 ingame web*/
	int	UserForgotPass(
		char* szUsrID,
		char* szPasswd );
	...
	int GetItemMall( std::vector<ITEMMALLDATA> &v );
	int GetItemMall( ITEMMALLDATA &sItemData, DWORD dwProductNum );
	int InsertBuyItemMall( DWORD dwProductNum, DWORD dwPrice, int wType, CString strUserID );

	/*dmk14 ingame web end*/

	/*dmk14 topup generator*/
	int GenerateTopUpCode( DWORD dwEpValue, DWORD dwCpValue, DWORD dwPrice, DWORD dwUserID, DWORD dwClientID );
	int GetTopUpCode( CString &strCode, CString &strPin, DWORD dwID );
	int ViewTopUpCode( WORD &wStatus, WORD &wValue, CString &strUserTopUp, CString strCode );

	/////////////////////////////////////////////////////////////////////////////
	// LG-7 GlobalRanking
	int GetTopKill(VEC_TOP_KILL& vecKill, int nIndex);
