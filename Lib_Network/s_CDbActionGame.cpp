	...
	EMACCTYPE emUserType )
{
	...
	/*dmk14 ingame web*/
	m_cCharAgData.m_dwPremiumPoints = dwPremiumPoints;
	m_cCharAgData.m_dwCombatPoints = dwCombatPoints;

	m_cCharAgData.m_emUserType = emUserType;
}
	...
	EMACCTYPE emUserType )
{
	...
	/*dmk14 ingame web*/
	m_cCharData.m_dwPremiumPoints = dwPremiumPoints;
	m_cCharData.m_dwCombatPoints = dwCombatPoints;

	m_cCharData.m_emUserType = emUserType;
}
