...
DWORD GLCROWLOGIC::RECEIVE_DAMAGE ( const DWORD dwDamage )
{
	DWORD dwOLD = m_dwNowHP;

	DECREASE(m_dwNowHP,dwDamage);
...
BOOL GLCROWLOGIC::ISHAVE_BUFF( SNATIVEID skill_id, WORD wLEVEL/*=1*/ )
{
	//level range 1~9
...
int GLCROWLOGIC::ISHAVE_BUFF( EMSPEC_ADDON emSPECS )
{
...
int GLCROWLOGIC::ISHAVE_BUFF( EMIMPACT_ADDON emADDONS )
{
