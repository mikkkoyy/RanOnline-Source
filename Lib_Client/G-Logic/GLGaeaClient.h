...
public:
	...
	GLGaeaClient &GetGaeaClient() { return *this; }
...
public:
	...
	DETECTMAP* DetectCrowBot ( DWORD emCrow, const D3DXVECTOR3 &vTarPos, const float fLength );
...
public:
	void	SetCharacterSimple( BOOL bCharacterSimple, BOOL bCharacterMisc ); /*character simple, Juver, 2017/10/01 */
