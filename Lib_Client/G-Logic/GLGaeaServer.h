...
public:
	...
	/*dmk14 ingame web*/
	MAPITEMMALL				m_mapItemMall;


	/*dmk14 slot event*/
	SNATIVEID				m_sItemSlotReward;
	WORD					m_wSlotMin;
	WORD					m_wSlotMax;
	WORD					m_wWinner;
	WORD					m_wMaxChar;
...
public:
	...
	BOOL RemoveFromPartyList ( PARTYLINKDATA sParty, DWORD dwPartyID = PARTY_NULL, BOOL bFromExitGame = FALSE );
	BOOL UpdatePartyList ( PARTYLINKDATA &sPartyNew );
...
public:
	...
	/*PartySearch - Added By Bubu*/
	BOOL	ReqSearchPartyList ( DWORD dwClientID, DWORD dwGaeaID, GLMSG::SNET_GET_PARTYLIST* pNetMsg );

	/*dmk14 ingame web*/
	BOOL	ReqItemMallList ( DWORD dwClientID, DWORD dwGaeaID, GLMSG::SNET_GET_ITEMMALL_FROMDB* pNetMsg );
public:
...
public:
	...
	BOOL ServerSlotEventGen( GLMSG::SNET_SLOT_EVENT_GEN_FLD * pNetMsg );
...
public:
	...
	void SENDTOGM_ONMAP ( DWORD dwMapID, LPVOID nmg );
