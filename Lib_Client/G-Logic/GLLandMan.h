...
struct SSKILLACTEX
{
	...
	SSKILLACTEX () :
		...
		bTeleport(false),
		vTeleport_Pos(D3DXVECTOR3(0,0,0)),
	...
	bool VALID() const
	{
		...
		//Teleport Skill Effect
		if ( vTeleport_Pos != D3DXVECTOR3(0,0,0))	return true;
...
public:
	...
	//Teleport Skill Effect
	void TeleportAct( const STARGETID dwActorID, D3DXVECTOR3 vPos);
	...
	bool GetPushPullPos( D3DXVECTOR3& vDestPos, GLACTOR* pACTOR, GLACTOR* pREACTOR, const float fPUSH_PULL );
	void SwapPosAct( const STARGETID& dwActorID, const STARGETID& dwReActorID, const float fPUSH_SPEED, DWORD dwSwapType );
...
public:
	...
	/*anti shit gs*/
public:
	BOOL IsLayerSimpleCollision( const D3DXVECTOR3& vStart, const D3DXVECTOR3& vEnd );
