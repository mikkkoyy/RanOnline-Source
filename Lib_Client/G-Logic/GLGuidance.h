...
public:
	...
	// LG-7 CWRanking
public:
	MAP_CW_RANKING		m_mapCWRanking;
	VEC_CW_RANKING		m_vecCWRanking;
	SCW_RANKING_REWARD	m_sCWRankingReward;
	float				m_fCWRankingUpdate;

	void AddCWRanking(DWORD dwKillID, DWORD dwDeathID);
	void UpdateCWRanking();
	void CWReward();
	void ReqCWRanking(DWORD dwClientID);
	void ReqMyCWRanking(DWORD dwClientID, DWORD dwCharID);
	/////////////////////////////////////////////////////////////////////////////
};
