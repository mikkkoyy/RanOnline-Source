...
namespace SKILL
{
	...
	enum EMSPEC_STIGMA_TYPE_DWORD // 낙인 효과 적용 타입 플래그
	{
		...
		EMSPEC_STIGMA_TYPE_DWORD_DAMAGE_NORMAL  = (1 << EMSPEC_STIGMA_TYPE_ATTACK ),
		EMSPEC_STIGMA_TYPE_DWORD_DAMAGE_SKILL   = (1 << EMSPEC_STIGMA_TYPE_SKILL  ),
		EMSPEC_STIGMA_TYPE_DWORD_BUFF_SKILL     = (1 << EMSPEC_STIGMA_TYPE_BUFF   ),
		EMSPEC_STIGMA_TYPE_DWORD_DEBUFF_SKILL   = (1 << EMSPEC_STIGMA_TYPE_DEBUFF ),
		EMSPEC_STIGMA_TYPE_DWORD_LIMIT_SKILL    = (1 << EMSPEC_STIGMA_TYPE_LIMIT  ),
	};
	...
	enum EMSPEC_HALLUCINATE_TYPE
	{
		...
		EMSPEC_HALLUCINATE_TYPE_SIZE			= 3,
	};
	...
	enum EMSPEC_HALLUCINATE_FLAG
	{
		...
		EMSPEC_HALLUCINATE_DWORD_EMOTICON = (1 << EMSPEC_HALLUCINATE_TYPE_FORCE_ACTION),	
	...
	enum EMSPEC_ASIGN_TYPE_DWORD
	{
		...
		EMSPEC_SKILL_ASING_DWORD_BEFORE = ( 1 << EMSPEC_ASIGN_TYPE_BEFORE ),
		EMSPEC_SKILL_ASING_DWORD_AFTER  = ( 1 << EMSPEC_ASIGN_TYPE_AFTER  ),
	};
