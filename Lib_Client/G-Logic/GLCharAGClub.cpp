...
HRESULT GLCharAG::MsgClubMemberReqAgt ( NET_MSG_GENERIC* nmg )
{
	...
	if ( pCHAR->m_tSECEDE!=0 )
	{
		...
		if ( GLCONST_CHAR::dwCLUB_JOINBLOCK_DAY < 10 )
			sSpan = CTimeSpan(GLCONST_CHAR::dwCLUB_JOINBLOCK_DAY,0,10,0);
		else sSpan = CTimeSpan(0,0,GLCONST_CHAR::dwCLUB_JOINBLOCK_DAY,0);
