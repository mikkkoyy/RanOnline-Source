...
HRESULT GLChar::MsgReqClubStorageSaveMoney ( NET_MSG_GENERIC* nmg )
{
	...
	
	{
		...
		string str;
		sprintf( szTempChar, ",[%s][%s] %s,", m_szUID, m_szName, "Save Club Storage Money," );
		str = szTempChar;
		
		if( pNetMsg->lnMoney < 0 )
		{
			str += " Not Correct Update Money Value!!";
		}

		sprintf( szTempChar, " Current Money %I64d, Update Money %I64d Money In, Current Club Storage Money %I64d, Update Club Storage Money %I64d Money In!!", m_lnMoney, m_lnMoney - pNetMsg->lnMoney,pCLUB->m_lnStorageMoney, pCLUB->m_lnStorageMoney + pNetMsg->lnMoney );
		str += szTempChar;
...
HRESULT GLChar::MsgReqClubStorageDrawMoney ( NET_MSG_GENERIC* nmg )
{
	...
	
	{
		char szTempChar[256] = {0,};
		string str;
		sprintf( szTempChar, ",[%s][%s] %s,", m_szUID, m_szName, "Draw Club Storage Money," );
		str = szTempChar;
		...
		sprintf( szTempChar, " Current Money %I64d, Update Money %I64d Money Out, Current Club Storage Money %I64d,  Update Club Storage Money %I64d Money Out!!", m_lnMoney, m_lnMoney + pNetMsg->lnMoney,pCLUB->m_lnStorageMoney, pCLUB->m_lnStorageMoney - pNetMsg->lnMoney );
		str += szTempChar;
