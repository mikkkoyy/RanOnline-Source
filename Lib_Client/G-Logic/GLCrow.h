...
public:
	...
	bool IsIgnoreShock()		{ return m_pCrowData->IsIgnoreShock(); }
...
public:
	...
	virtual bool MoveTo ( const D3DXVECTOR3 *vTarPos, bool bJump, DWORD dwFlags );

protected:
	HRESULT MoveTo ( const D3DXVECTOR3 &vTarPos, bool bJump );
