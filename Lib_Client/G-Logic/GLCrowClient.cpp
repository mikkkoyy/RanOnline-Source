...
void GLCrowClient::ReceiveDamage ( DWORD dwDamage, DWORD dwDamageFlag, STARGETID sACTOR )
{
	...
	case NET_MSG_GCTRL_REMOVE_SKILL_EFFECT_BRD:
		{
			...
			FACTEFF::DeleteSkillFactEffect ( STARGETID(CROW_MOB,m_dwGlobID,m_vPos), m_pSkinChar, m_sSKILLFACT[pNetMsg->dwSkillID].sNATIVEID );
