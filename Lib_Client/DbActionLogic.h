...
class CUpdateMoneyPoints : public CDbAction
{
public:
	CUpdateMoneyPoints( DWORD dwPremium, CString strUserID );
	virtual ~CUpdateMoneyPoints() {};
	virtual int Execute ( CServer* pServer );

protected:
	DWORD	m_dwPremium;
	DWORD	m_dwCombatPoint;
	CString m_strUserID;
};

//PANDORA - Added by Arwekaj09 to Deduct UserPoint or E-Points
class CDeductMoneyPoints : public CDbAction
{
public:
	CDeductMoneyPoints( DWORD dwPremium, CString strUserID );
	virtual ~CDeductMoneyPoints() {};
	virtual int Execute ( CServer* pServer );
...
{
public:
	CStorageLockEnable ( DWORD dwClientID, DWORD dwChaNum, const char* szChaName, const char* szSPin );
...
protected:
	DWORD m_dwChaNum;	
	char  m_szChaName[CHR_ID_LENGTH+1];
	char  m_szSPin[USER_STORAGE_LOCK_PASS_SIZE+1];	
};
...
{
public:
	CStorageLockInput ( DWORD dwClientID, DWORD dwChaNum, const char* szChaName, const char* szSPin );
...
/*storage lock, Juver, 2018/01/16 */
class CStorageLockRecover : public CDbAction
{
public:
	CStorageLockRecover ( DWORD dwClientID, DWORD dwChaNum, const char* szChaName );
	virtual ~CStorageLockRecover() {};
	virtual int Execute (CServer* pServer);	
...
class CStorageLockRecoverChange : public CDbAction
{
public:
	CStorageLockRecoverChange ( DWORD dwClientID, DWORD dwChaNum, const char* szChaName, const char* szSPin );
	virtual ~CStorageLockRecoverChange() {};
	virtual int Execute (CServer* pServer);	
...
class CStorageLockRecoverDelete : public CDbAction
{
public:
	CStorageLockRecoverDelete ( DWORD dwClientID, DWORD dwChaNum, const char* szChaName );
	virtual ~CStorageLockRecoverDelete() {};
	virtual int Execute (CServer* pServer);	
...
{
public:
	CInventoryLockEnable ( DWORD dwClientID, DWORD dwChaNum, const char* szChaName, const char* szIPin );
...
protected:
	DWORD m_dwChaNum;	
	char  m_szChaName[CHR_ID_LENGTH+1];
	char  m_szIPin[CHAR_INVENTORY_LOCK_PASS_SIZE+1];	
};
...
{
public:
	CInventoryLockInput ( DWORD dwClientID, DWORD dwChaNum, const char* szChaName, const char* szIPin );
...
/*inventory lock, Juver, 2018/01/16 */
class CInventoryLockRecover : public CDbAction
{
public:
	CInventoryLockRecover ( DWORD dwClientID, DWORD dwChaNum, const char* szChaName );
	virtual ~CInventoryLockRecover() {};
	virtual int Execute (CServer* pServer);	
...
class CInventoryLockRecoverChange : public CDbAction
{
public:
	CInventoryLockRecoverChange ( DWORD dwClientID, DWORD dwChaNum, const char* szChaName, const char* szIPin );
	virtual ~CInventoryLockRecoverChange() {};
	virtual int Execute (CServer* pServer);	
...
class CInventoryLockRecoverDelete : public CDbAction
{
public:
	CInventoryLockRecoverDelete ( DWORD dwClientID, DWORD dwChaNum, const char* szChaName );
	virtual ~CInventoryLockRecoverDelete() {};
	virtual int Execute (CServer* pServer);	
