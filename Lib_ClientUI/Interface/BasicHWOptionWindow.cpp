...
void CBasicHWOptionWindow::GamePlayOption_OK()
{
	...
	RANPARAM::bCharacterMisc	= m_pGamePlayOption->m_bCharacterMisc;
	RANPARAM::bHideSkillEffect	= m_pGamePlayOption->m_bHideSkillEffect;	/*skill effect setting, Juver, 2017/10/01 */
	RANPARAM::bHideDamageDisplay = m_pGamePlayOption->m_bHideDamageDisplay;
	RANPARAM::bSpecialName = m_pGamePlayOption->m_bSpecialName;
	RANPARAM::bClassicNameDisplay = m_pGamePlayOption->m_bClassicNameDisplay;
	RANPARAM::bKillFeedDisplay = m_pGamePlayOption->m_bKillFeedDisplay;
	RANPARAM::bHideDeadName = m_pGamePlayOption->m_bHideDeadName;
	RANPARAM::bHideDeadBody = m_pGamePlayOption->m_bHideDeadBody;
	RANPARAM::bPrivateStats		= m_pGamePlayOption->m_bPrivateStats;		/*charinfoview , Juver, 2017/11/12 */

	GLGaeaClient::GetInstance().SetCharacterSimple( RANPARAM::bCharacterSimple, RANPARAM::bCharacterMisc );	/*character simple, Juver, 2017/10/01 */
