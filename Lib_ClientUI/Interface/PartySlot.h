...
private:
	...
	CUIControl*		m_pClassDie[GLCI_NUM_8CLASS];
...
public:
	...
	void			SetInfo(CString strLevel, CString strMap, DWORD dwGaeaID, CString strName, CString strPos, BOOL bSELF = FALSE);

	void			SetSelect(BOOL bSELECT);
	BOOL			IsSELECT() { return m_bSelect; }

	CBasicButton*	m_pAddFriendBtn;
	CBasicButton*	m_pViewCharBtn;
};