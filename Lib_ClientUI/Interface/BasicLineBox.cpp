...
void CBasicLineBox::CreateBaseBoxYellow ( char* szBoxControl )
{
	//CreateBodyImage ( "BASIC_LINE_BOX_BODY_YELLOW" );
	CreateLineImage ( "BASIC_LINE_BOX_LEFT_YELLOW", "BASIC_LINE_BOX_RIGHT_YELLOW", "BASIC_LINE_BOX_TOP_YELLOW", "BASIC_LINE_BOX_BOTTOM_YELLOW" );
	ResizeControl ( szBoxControl );
}
