...
namespace	NS_UITEXTCOLOR
{
	...
	const DWORD CHATNAME		= D3DCOLOR_ARGB(0xFF,0x21,0x87,0xB9);
	const DWORD GREEN			= D3DCOLOR_RGBA(000,255,000,255);	//color green
	// itemName color drop
	const DWORD NORMAL			= D3DCOLOR_ARGB(0xFF,0xFF,0xFF,0xFF);
	const DWORD RARE			= D3DCOLOR_ARGB(255,051,153,255);
	const DWORD VERYRARE		= D3DCOLOR_ARGB(255,255,255,051);
	const DWORD EPIC			= D3DCOLOR_ARGB(255,255,051,255);
	const DWORD UNIQUE			= D3DCOLOR_ARGB(255,255,153,051);
	//wow colors
	...
	//new color
	const DWORD dwDefault			= D3DCOLOR_RGBA(255,255,255,255);	//default color							- white
	const DWORD dwItemRank0			= D3DCOLOR_RGBA(255,255,255,255);	//color by weapon's rank(normal)		- white
	const DWORD dwItemRank1			= D3DCOLOR_RGBA(117,255,255,255);	//color by weapon's rank(rare)			- light blue
	const DWORD dwItemRank2			= D3DCOLOR_RGBA(255,255,000,255);	//color by weapon's rank(unique)		- yellow
	const DWORD dwItemRank3			= D3DCOLOR_RGBA(234,050,186,255);	//color by weapon's rank(unlimited)		- purple
	const DWORD dwItemRank4			= D3DCOLOR_RGBA(255,142,043,255);	//color by weapon's rank(climax)		- orange
	const DWORD dwReqWrong			= D3DCOLOR_RGBA(255,000,000,255);	//color item requirement error			- red
	const DWORD dwInchant1			= D3DCOLOR_RGBA(117,255,255,255);	//color of default attack + inchanted	- light blue
	const DWORD dwInchant2			= D3DCOLOR_RGBA(255,255,000,255);	//color of inchanted					- yellow
	const DWORD dwEquipCostum		= D3DCOLOR_RGBA(60,255,150,255);	//color of costume info					- blue-green
	const DWORD dwRankUp1			= D3DCOLOR_RGBA(117,255,255,255);	///color of default stat + inchanted	- light blue
	const DWORD dwRankUp2			= D3DCOLOR_RGBA(255,255,000,255);	//color of inchanted					- yellow
	const DWORD dwSPReduce			= D3DCOLOR_RGBA(255,125,180,255);	//color of additional consume SP		- pink
	const DWORD dwAddAbility		= D3DCOLOR_RGBA(000,255,000,255);	//color of additional ability			- green
	const DWORD dwRandomAbility		= D3DCOLOR_RGBA(118,238,198,255);	//color of random ability				- light blue-green
	const DWORD dwElementalAbility	= D3DCOLOR_RGBA(255,255,000,255);	//color of state odd					- yellow
	const DWORD dwTrade				= D3DCOLOR_RGBA(150,150,150,255);	//color of non-trade					- gray
	const DWORD dwLimitTime			= D3DCOLOR_RGBA(247,150,070,255);	//color of limit time of item			- orange

	//	»ç¿ëÃ³
	const DWORD ENABLE			= dwDefault;	
