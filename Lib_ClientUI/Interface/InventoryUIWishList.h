...
class	CInventoryUIWishList : public CUIGroup
{
...
protected:
	...
	{
		ITEM_SLOT0 = NO_ID + 1,
		ITEM_SLOT_END = ITEM_SLOT0 + WISHLIST_INVEN_Y,
		PAGE_BUTTON0,
		PAGE_BUTTON1,
		PAGE_BUTTON2,
		PAGE_BUTTON3,
...
public:
	CInventoryUIWishList ();
	virtual	~CInventoryUIWishList ();
...
private:
	CItemSlot*	m_pItemSlotArray[WISHLIST_INVEN_Y];
