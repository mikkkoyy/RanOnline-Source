...
private:
	...
	CBasicTextButton*	CreateTextButtonClick ( char* szButton, char* szTextBox, CD3DFontPar* pFont, int nAlign, UIGUID ControlID, CString strText );
...
protected:
    ...
    RnButton*		m_pButtonAdd_Pow;
    RnButton*		m_pButtonAdd_Dex;
    RnButton*		m_pButtonAdd_Spi;
    RnButton*		m_pButtonAdd_Str;
    RnButton*		m_pButtonAdd_Sta;

    RnButton*		m_pButtonDeduct_Pow;
    RnButton*		m_pButtonDeduct_Dex;
    RnButton*		m_pButtonDeduct_Spi;
    RnButton*		m_pButtonDeduct_Str;
    RnButton*		m_pButtonDeduct_Sta;

	RnButton*		m_pButtonStats_Apply;
	RnButton*		m_pButtonStats_Reset;

	RnButton*		m_pBlankButton_Apply;
	RnButton*		m_pBlankButton_Reset;
