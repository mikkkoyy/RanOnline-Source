...
//			if ( CUIMan::GetFocusControl () == this )
			...
			{				
				if ( sInvenItem.sItemCustom.sNativeID != NATIVEID_NULL () )
				{
					...
					//{
					//	CInnerInterface::GetInstance().SHOW_ITEM_INFO ( sInvenItem.sItemCustom, TRUE, TRUE, FALSE, sInvenItem.wPosX, sInvenItem.wPosY, m_sMarketID, FALSE, 0, FALSE, FALSE, FALSE, TRUE );
					//}
					//else CInnerInterface::GetInstance().SHOW_ITEM_INFO ( sInvenItem.sItemCustom, TRUE, TRUE, FALSE, sInvenItem.wPosX, sInvenItem.wPosY, m_sMarketID );
					...
					CInnerInterface::GetInstance().SHOW_ITEM_INFO_NEW ( sInvenItem.sItemCustom, TRUE, TRUE, FALSE, TRUE, FALSE, sInvenItem.wPosX, sInvenItem.wPosY, m_sMarketID );
				}
