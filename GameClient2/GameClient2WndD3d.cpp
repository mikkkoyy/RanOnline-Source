...
HRESULT CGameClient2Wnd::CreateObjects()
{
	...
	//hr = NLOADINGTHREAD::StartThreadLOAD ( &m_pd3dDevice, m_hWnd, ((CGameClient2App*)AfxGetApp())->m_szAppPath, CString("loading_000.dds"), FALSE );
	hr = NLOADINGTHREAD::StartThreadLOAD ( &m_pd3dDevice, m_hWnd, ((CGameClient2App*)AfxGetApp())->m_szAppPath, CString("loading_000.dds"), CString ("Ran Online"), FALSE );
