...
public:
	...
	*/
	...
	virtual int UpdateMoneyPoint(DWORD dwPremium, CString strUserID )	{return 0;}

	//PANDORA - Added by Arwekaj09 to Deduct UserPoint or E-Points
	virtual int DeductMoneyPoint(DWORD dwPremium, CString strUserID )	{return 0;}
	...
	*/
	...
	virtual int EquipmentLockEnable (DWORD dwChaNum, char* szChaName, char* szEPin ) { return 0; }
	virtual int EquipmentLockInput (DWORD dwChaNum, char* szChaName, char* szEPin ) { return 0; }
	virtual int EquipmentLockRecover (DWORD dwChaNum, char* szChaName, std::string& strEPin ) { return 0; }
	virtual int EquipmentLockRecoverChange (DWORD dwChaNum, char* szChaName, char* szEPin ) { return 0; }
	virtual int EquipmentLockRecoverDelete (DWORD dwChaNum, char* szChaName ) { return 0; }

	/*dmk14 ingame web*/
	virtual int GetItemMall( std::vector<ITEMMALLDATA> &v ) { return 0; } 
	virtual int GetItemMall( ITEMMALLDATA &sItemData, DWORD dwProductNum )	{return 0;}
	virtual int InsertBuyItemMall(DWORD dwProductNum, DWORD dwPrice, int wType, CString strUserID )	{return 0;}

	/*storage lock, Juver, 2018/01/14 */
	virtual int StorageLockEnable (DWORD dwChaNum, char* szChaName, char* szSPin ) { return 0; }
	virtual int StorageLockInput (DWORD dwChaNum, char* szChaName, char* szSPin ) { return 0; }
	virtual int StorageLockRecover (DWORD dwChaNum, char* szChaName, std::string& strSPin ) { return 0; }
	virtual int StorageLockRecoverChange (DWORD dwChaNum, char* szChaName, char* szSPin ) { return 0; }
	virtual int StorageLockRecoverDelete (DWORD dwChaNum, char* szChaName ) { return 0; }

	/*inventory lock, Juver, 2018/01/14 */
	virtual int InventoryLockEnable (DWORD dwChaNum, char* szChaName, char* szIPin ) { return 0; }
	virtual int InventoryLockInput (DWORD dwChaNum, char* szChaName, char* szIPin ) { return 0; }
	virtual int InventoryLockRecover (DWORD dwChaNum, char* szChaName, std::string& strIPin ) { return 0; }
	virtual int InventoryLockRecoverChange (DWORD dwChaNum, char* szChaName, char* szIPin ) { return 0; }
	virtual int InventoryLockRecoverDelete (DWORD dwChaNum, char* szChaName ) { return 0; }
	/////////////////////////////////////////////////////////////////////////////
	// LG-7 GlobalRanking
	virtual int GetTopKill(VEC_TOP_KILL& vecKill, int nIndex)	{ return 0; }
