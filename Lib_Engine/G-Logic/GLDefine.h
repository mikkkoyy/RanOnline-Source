...
struct GLDWDATA
{
	...
	void INCREASE ( const DWORD dwValue, const BOOL bRate=FALSE )
	{
...
enum DAMAGE_TYPE
{
	...
	DAMAGE_TYPE_DAMAGE_ABSORBED		= 0x0080,	// 마법 반사
	DAMAGE_TYPE_IMMUNE				= 0x0100,	// 마법 반사
	DAMAGE_TYPE_ILLUSION			= 0x0200,	// 환술
};
