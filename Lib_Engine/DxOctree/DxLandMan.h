...
//ADDED VER 121 FROM GS NRDEV
	BOOL LoadFile_VER121 ( const char *szFile, LPDIRECT3DDEVICEQ pd3dDevice, BOOL bUseDynamicLoad, const char* szPathName );	// m_spStaticMaterialMeshLightMap ???.
