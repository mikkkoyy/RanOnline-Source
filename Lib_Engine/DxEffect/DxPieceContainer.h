...
protected:
	...
	static const DWORD VERSION_PIE;
...
private:
	...
	BOOL LOADPIE_0101 ( CSerialFile &SFile, LPDIRECT3DDEVICEQ pd3dDevice );
	...
	BOOL LOADPIE_0105_6 ( CSerialFile &SFile, LPDIRECT3DDEVICEQ pd3dDevice );
	BOOL LoadPIE_0107( LPDIRECT3DDEVICEQ pd3dDevice, CSerialFile& SFile, const TSTRING& strPieceEditPath );	//	FrameMeshName 과 정보도 저장되도록 수정함.
	BOOL LoadPIE_0108( LPDIRECT3DDEVICEQ pd3dDevice, CSerialFile& SFile, const TSTRING& strPieceEditPath );	//	LOD(AlphaBlend) 기능 추가
	BOOL LoadPIE_0109( CSerialFile& SFile );																	//	FrameMeshName 과 정보 저장 필요없음.
