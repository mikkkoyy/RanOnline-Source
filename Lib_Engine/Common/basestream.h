...
public:
	...
	virtual void SetEncodeType ( EMBYTECRYPT emCrypt ){CALLERROR;}
	//wld crypt
	virtual void SetEncode ( bool bencode, EMENCODE_TYPE emType = EMENCODE_NONE ){CALLERROR;}	
...
public:
	basestream() :
		...
		m_DefaultOffSet(0),
		m_dwBlockMarkPOS(0),
		m_emCrypt(EMBYTECRYPT_NONE),
		//wld crypt
		m_emEncodeType( EMENCODE_NONE ),
		m_nVersion(-1)
	{
