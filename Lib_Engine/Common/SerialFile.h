...
public:
	...
	BOOL OpenFile ( const FOPENTYPE _Type, const char *_szFileName, EMBYTECRYPT emCrypt = EMBYTECRYPT_NONE );
...
public:
	CSerialFile ();
	CSerialFile ( FOPENTYPE _Type, const char *_szFileName, EMBYTECRYPT emCrypt = EMBYTECRYPT_NONE );
	virtual ~CSerialFile ();
};
